    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(
                builder.Configuration["Jwt:AccessTokenSecret"] ?? "your-super-secret-access-token-key-here-make-it-long-and-secure")),
            ValidateIssuer = true,
            ValidIssuer = builder.Configuration["Jwt:Issuer"] ?? "ElsewedyCapstoneSystem",
            ValidateAudience = true,
            ValidAudience = builder.Configuration["Jwt:Audience"] ?? "ElsewedyCapstoneSystem",
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAll", policy =>
        policy.WithOrigins("http://localhost:5173", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003", "http://localhost:4200", "http://192.168.10.32:1003", "https://192.168.10.32:1003", "http://sewedycapstone.runasp.net", "https://sewedycapstone.runasp.net")
              .AllowAnyMethod()
              .AllowAnyHeader()
              .AllowCredentials());
});
