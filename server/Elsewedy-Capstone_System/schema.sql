...
CREATE TABLE [Account] (
    ...
    CONSTRAINT [FK_Account_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [CapstoneSupervisorExtension] (
    ...
    CONSTRAINT [FK_CapstoneSupervisorExtension_Account_AccountId] FOREIGN KEY ([AccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_CapstoneSupervisorExtension_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Grade] (
    ...
    CONSTRAINT [FK_Grade_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Login] (
    ...
    CONSTRAINT [FK_Login_Account] FOREIGN KEY ([AccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Login_Status] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Project] (
    ...
    CONSTRAINT [FK_Project_Account_SupervisorAccountId] FOREIGN KEY ([SupervisorAccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Project_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Report] (
    ...
    CONSTRAINT [FK_Report_Account_SubmitterAccountId] FOREIGN KEY ([SubmitterAccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Report_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [SuperAdminExtension] (
    ...
    CONSTRAINT [FK_SuperAdminExtension_Account_AccountId] FOREIGN KEY ([AccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_SuperAdminExtension_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [Tbl_Class] (
    ...
    CONSTRAINT [FK_Tbl_Class_Grade_GradeId] FOREIGN KEY ([GradeId]) REFERENCES [Grade] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Tbl_Class_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [ReviewerSupervisorExtension] (
    ...
    CONSTRAINT [FK_ReviewerSupervisorExtension_Account_AccountId] FOREIGN KEY ([AccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_ReviewerSupervisorExtension_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE,
...
CREATE TABLE [StudentExtension] (
    ...
    CONSTRAINT [FK_StudentExtension_Account_AccountId] FOREIGN KEY ([AccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_StudentExtension_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE,
...
CREATE TABLE [Team] (
    ...
    CONSTRAINT [FK_Team_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Team_Tbl_Class_ClassId] FOREIGN KEY ([ClassId]) REFERENCES [Tbl_Class] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [StudentTask] (
    ...
    CONSTRAINT [FK_StudentTask_Account_StudentAccountId] FOREIGN KEY ([StudentAccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_StudentTask_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_StudentTask_Tbl_Task_TaskId] FOREIGN KEY ([TaskId]) REFERENCES [Tbl_Task] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [TaskSubmission] (
    ...
    CONSTRAINT [FK_TaskSubmission_Account_TeamLeader_ID] FOREIGN KEY ([TeamLeader_ID]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TaskSubmission_Grade_Grade_ID] FOREIGN KEY ([Grade_ID]) REFERENCES [Grade] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TaskSubmission_Team_Team_ID] FOREIGN KEY ([Team_ID]) REFERENCES [Team] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [TeamMember] (
    ...
    CONSTRAINT [FK_TeamMember_Account_TeamMemberAccountId] FOREIGN KEY ([TeamMemberAccountId]) REFERENCES [Account] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TeamMember_Status_StatusId] FOREIGN KEY ([StatusId]) REFERENCES [Status] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_TeamMember_Team_TeamId] FOREIGN KEY ([TeamId]) REFERENCES [Team] ([Id]) ON DELETE CASCADE
);
GO
